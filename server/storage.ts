...
export class MemStorage implements IStorage {
  ...
  private initializeFactoryPresets() {
    const factoryPresets: Omit<Preset, 'id'>[] = [
      ...
      // HIGH GAIN WITH DELAY & REVERB
      {
        name: 'EPIC LEAD DELAY',
        settings: {
          ...defaultAmpSettings,
          inputGain: 7,
          bass: 5,
